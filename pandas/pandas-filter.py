...
# dataframe with values of column A > 50 and columns A and B
result = df[df["A"] > 50][["A", "B"]]
# dataframe with values of column A > 50 and column B > 50
result = df[(df["A"] > 50) & (df["B"] > 50)]
# dataframe with values of column A > 50 or column B > 50
result = df[(df["A"] > 50) | (df["B"] > 50)]
# dataframe with values of column A > 50 and column B > 50 and columns A and B
result = df[(df["A"] > 50) & (df["B"] > 50)][["A", "B"]]

# dataframe with values of column A > 50 and column B > 50
result = df.query('A > 50 and B > 50')
# dataframe with values of column A > 50 and column B > 50 and columns A and B
result = df.query('A > 50 and B > 50')[["A", "B"]]
print(result)
