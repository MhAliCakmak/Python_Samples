...
# get title and genre of movie in 5 to 10 rows
result = df[5:10][["Title", "Genre"]]
# get the movies with international sales > 100000000]]]
result = df[df["International Sales (in $)"] > 100000000][[
    "Title", "Genre"]].head(50)
# Display the data
print(result)
